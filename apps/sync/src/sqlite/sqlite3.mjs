...
import sqliteOPFS from "blob-url:./sqlite3-opfs-async-proxy.js"
import sqlite3Wasm from "blob-url:./sqlite3.wasm"
    ...
    Module.postRun.push(function (Module) {
      ...
      self.sqlite3ApiBootstrap.initializers.push(function (sqlite3) {
        sqlite3.version = {
          ...
          sourceId:
            "2023-01-27 05:14:34 fa784101775b795077a23c211b5b16f51ad5a13967c284511f310dfcbfa9f77a",
      ...
      self.sqlite3ApiBootstrap.initializers.push(function (sqlite3) {
        const installOpfsVfs = function callee(options) {
          ...
          const thePromise = new Promise(function (
            ...
            const W = new Worker(sqliteOPFS, { type: "module" })
